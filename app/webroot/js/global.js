...
function cdHandler(disclosurePosition, privacyPolicyUri, cookieScripts) {
    ...
    disclosure+= 'Strona korzysta z plików cookies zgodnie z ' +
        '<a style="color:#ca0000;font-weight:bold;font-family:arial;font-size:14px;" href="'+ epdPrivacyPolicyUri + '">Polityką Plików Cookies</a>.' +
        ' Bez obaw - cookies nie są ani niebezpieczne, ani uciążliwe. Niemal każda strona z nich korzysta.' +
        ' Ale ludzie, którzy za nasze pieniądze siedzą w Brukseli z nudów wymyślają' +
        ' tak ciekawe przepisy jak ten, przez który teraz na wszystkich stronach  widnieje tego typu ostrzeżenie.' +
        ' Jeśli nie chcesz otrzymywać plików cookies, zmień ustawienia przeglądarki, ale najlepiej zastanów się przy następnych eurowyborach..' +
        '</div>';
...
//    disclosure += '<input type="submit" name="epdsubmit" id="epdsubmit" value="Continue"/><br/><br/></div>' +
