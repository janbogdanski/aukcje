 ...
 */
/*
	I have modified this component to work with User Management Plugin.
	If you have any questions please let me know at chetanvarshney@gmail.com
*/
 ...
 * @var string
 */
	/* Modified by Chetan Varshney */
	public static $sessionKey = 'UserAuth.User';
 ...
 */
	public static function user($key = null) {
		...
		if(!empty($user)) {
			$groupId = CakeSession::read('UserAuth.User.user_group_id');
 ...
 */
	public function redirect($url = null) {
		...
		if (!is_null($url)) {
			$redir = $url;
			$this->Session->write('Usermgmt.OriginAfterLogin', $redir);
		} elseif ($this->Session->check('Usermgmt.OriginAfterLogin')) {
			$redir = $this->Session->read('Usermgmt.OriginAfterLogin');
